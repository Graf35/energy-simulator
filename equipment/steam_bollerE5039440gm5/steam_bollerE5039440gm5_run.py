...
class Steam_bollerE5039440gm5():
    ...
    def run_boler(self):
        while True:
            ...
            self.send_data("K0P102_1 " + str(round(self.bolier.K0P102_1, 2)))
            self.bolier.change_K0T104_2()
            self.send_data("K0T104_2 " + str(round(self.bolier.K0T104_2, 2)))
            self.bolier.change_K5F6x()
            self.send_data("K5F6x " + str(round(self.bolier.K5F6x, 2)))
