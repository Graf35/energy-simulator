...
class Steam_bollerE5039440gm5():
    ...
    def run_boler(self):
        while True:
            ...
            self.bolier.change_K5P17_1()
            self.data_append("K5P17_1 " + str(round(self.bolier.K5P17_1, 2)))
            self.bolier.change_K5P17_2()
            self.data_append("K5P17_2 " + str(round(self.bolier.K5P17_2, 2)))
            self.drum_lavel()
